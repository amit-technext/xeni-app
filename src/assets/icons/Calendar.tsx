...
const SvgCalendar = (props: SVGProps<SVGSVGElement>) => (
	<svg
		...
		className='calendar_svg__svg-inline--fa calendar_svg__fa-calendar-alt calendar_svg__fa-w-14'
		...
		{...props}
	>
		<g className='calendar_svg__fa-group' fill='currentColor'>
			<path
				className='calendar_svg__fa-secondary'

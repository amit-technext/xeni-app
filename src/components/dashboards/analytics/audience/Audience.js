...
function TabTitle({ title, value, percentage, progress }) {
	return (
		<div className='p-2 pe-4 text-start cursor-pointer'>
			...
			<Flex alignItems='center'>
				...
				/>
				<h6
					className={`fs--2 mb-0 ms-2 ${progress ? 'text-success' : 'text-warning'}`}
				>
					{percentage}
				</h6>
			</Flex>
		...
		<Card className='overflow-hidden mb-3'>
						...
						<Nav className='nav-tabs border-0 flex-nowrap chart-tab'>
							<Nav.Item>
								<Nav.Link className='mb-0' eventKey='users'>
									<TabTitle title='Users' value='3.9K' progress percentage='62.0%' />
								</Nav.Link>
							</Nav.Item>
							<Nav.Item>
								<Nav.Link className='mb-0' eventKey='sessions'>
									<TabTitle title='Sessions' value='6.3K' progress percentage='46.2%' />
								</Nav.Link>
							</Nav.Item>
							<Nav.Item>
			...
			<Card.Footer className='bg-light py-2'>
				<Row className='g-0 flex-between-center'>
					...
					<Col xs='auto'>
						<FalconLink title='Visitors overview' className='px-0' />
					</Col>
				</Row>
			</Card.Footer>
		</Card>

...
import slider1 from '../../assets/img/slider/login.png'
...
export const sliders = [
	{
		...
		title: `Welcome to 
    [Your Travel Agency]`,
		shortDesc: 'Your Sub-Header Goes here'
	},
	{
		id: '2',
		image: slider1,
...
const LoginFlow: FC = function LoginFlow() {
	return (
		<Row
				...
				<Card className='signup-card position-absolute p-2 p-xxl-3'>
					<Card.Body>
						<Flex alignItems='center' justifyContent='between' className='mb-2 row'>
							<p className='col-auto fs-1 fs-sm-2 text-black fw-semi-bold mb-0 me-4 me-xxl-7'>
								Log in
							</p>

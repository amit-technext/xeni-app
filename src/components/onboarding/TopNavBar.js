...
import xeniLand from '../../assets/icon/xeni-land.png'
// import AppContext from '../../../context/Context'
// import flag from '../../../assets/img/generic/13.jpg';
...
function TopNavBar() {
	...
	return (
		<Flex
			...
			alignItems='center'
			className='px-2 bg-white px-sm-5 border-bottom shadow-sm mb-3'
		>
			<div>
				<Logo width={100} height={35} logo={xeniLand} />
			</div>

...
import UsageRestrictionsAdd from './UsageRestrictionsAdd';
import IconButton from 'components/common/utils/IconButton';
import TopPagesTable from './UsageRestrictionsTopPagesTable';
...
const TopPages = () => {
  const columns = LimitsData[8].columns;
  const data = LimitsData[8].data;
            ...
            <Flex justifyContent="end">
              <div className={'ms-3'}>
                ...
                >
                  ...
                  <Modal.Body>
                    <UsageRestrictionsAdd callBackSave={callBack} />

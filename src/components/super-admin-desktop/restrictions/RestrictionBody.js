...
// export default function RestrictionBody() {
...
//                     <Avatar src={data.avatar} size="l" name={data.Tanent} />
//                     <div className="ms-2">
//                         {data.Tanent}
...
//             <td className="text-nowrap">{data.ServiceType}</td>
...
//             </thead>
//             <tbody>
//                 {adminData[2].data.map((profile, index) => (

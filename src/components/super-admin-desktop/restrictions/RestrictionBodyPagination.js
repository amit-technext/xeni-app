...
import TopPagesTable from './RestrictionsTopPagesTable';
import {
  useTable,
  useSortBy,
  usePagination,
...
const TopPages = () => {
  const columns = LimitsData[2].columns;
  const data = LimitsData[2].data;
            ...
            <Flex justifyContent="end">
              <div className={'ms-3'}>
                ...
                >
                  ...
                  <Modal.Body>
                    <RestrictionsAdd callBackSave={callBack} />
                  </Modal.Body>
                </Modal>
              </div>
            </Flex>

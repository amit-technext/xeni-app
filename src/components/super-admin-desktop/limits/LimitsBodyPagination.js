...
import TopPagesTable from './LimitsTopPagesTable';
import {
  useTable,
  useSortBy,
  usePagination,
...
const TopPages = () => {
  const columns = LimitsData[5].columns;
  const data = LimitsData[5].data;
  ...
  return (
    <Card className="h-100">
      <Card.Header>
        <Row>
          <h6 className="mt-2 me-2 mb-0 text-nowrap py-2 py-xl-0 text-1000 fs-2 mb-3">
            Limits
          </h6>
        </Row>
            ...
            <Flex justifyContent="end">
              <div className={'ms-3'}>
                ...
                >
                  ...
                  <Modal.Body>
                    <LimitsAdd callBackSave={callBack} />

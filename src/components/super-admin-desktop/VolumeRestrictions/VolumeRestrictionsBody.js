...
import VolumeRestrictionsAdd from './VolumeRestrictionsAdd';
import TopPagesTable from './VolumeRestrictionsTopPagesTable';
...
const TopPages = () => {
  const columns = LimitsData[7].columns;
  const data = LimitsData[7].data;
            ...
            <Flex justifyContent="end">
              <div className={'ms-3'}>
                ...
                >
                  ...
                  <Modal.Body>
                    <VolumeRestrictionsAdd callBackSave={callBack} />
                  </Modal.Body>
                </Modal>
              </div>
            </Flex>

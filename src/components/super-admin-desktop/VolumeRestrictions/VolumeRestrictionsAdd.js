...
const VolumeRestrictionsAdd = ({ callBackSave }) => {
  ...
  return (
    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
      <Flex direction="column" className="ms-4 me-4">
        ...
        <Flex direction="row">
          <div className="pe-2 w-50">
            <Form.Label className="fs--2">TPS Limit</Form.Label>
            <Form.Control type="email" className="fs--1" placeholder="" />
          </div>
          <div className="pe-2 w-50">
            <Form.Label className="fs--2">Concurrent Requests Limit</Form.Label>
            <Form.Control type="email" className="fs--1" placeholder="" />
          </div>
        </Flex>
        <Flex direction="row">
          <div className="pe-2 w-50">
            <Form.Label className="fs--2">Volume Limit per Week</Form.Label>
            <Form.Control type="email" className="fs--1" placeholder="" />
          </div>
          <div>
...
VolumeRestrictionsAdd.propTypes = {
  callBackSave: PropTypes.func
};

export default VolumeRestrictionsAdd;
